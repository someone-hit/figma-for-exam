...
const Services = () => {
  return (
    <section className="max-w-[1130px] mx-auto pt-[100px]">
      <div className="flex items-center gap-[111px]">
        <div>
          <button className="border border-gray-100">
            <span className="font-medium text-[#FF6107] py-1 px-2">
              services
            </span>
          </button>
          <p className="font-bold text-[44px] w-[534px]">
            Exactly Everything You Need For Business
          </p>
        </div>

        <div>
          <p className="text-[#464646] font-normal w-[428px]">
      ...
      <div className="grid grid-cols-3  ">
        <Services_card
          ...
          className=" w-[364px] h-[415px]  rounded-2xl mt-5 mb-10!"
            btn='Learn More'
        ...
        <Services_card
          ...
          className=" w-[364px] h-[415px] shadow-xl rounded-2xl mt-5 mb-10!"
          btn='Learn More'
          btn_style='bg-[#FF823B] py-[15px] text-bold text-[18px] rounded-[31px] px-10 text-white'
        />
        <Services_card
          descrip="An exceptional plan can take you ahead millions of step which  we discove"
